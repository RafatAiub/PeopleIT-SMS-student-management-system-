...
export const LogoMark: React.FC<{ className?: string }> = ({ className = 'w-8 h-8' }) => {
  // Unique per instance: the app can render more than one LogoMark in the
  // same document (e.g. Login's desktop illustration + mobile header), and
  // duplicate SVG gradient IDs are undefined behavior across browsers.
