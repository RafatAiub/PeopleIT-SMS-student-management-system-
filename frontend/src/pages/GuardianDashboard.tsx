      ...
      {notices.length > 0 && (
        <div className="glass-card overflow-hidden border-l-4 border-l-amber-500">
          <div className="p-5 border-b border-slate-200 dark:border-white/5 flex items-center justify-between">
            ...
            <Link
              to="/notices"
              className="text-sm font-bold text-primary-600 dark:text-primary-400 hover:underline px-3 py-1.5 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-500/10"
            >
              View all
            </Link>
          </div>
          ...
          {children.map((child) => (
            ...
            >
              {child.avatarUrl ? (
                ...
                <span className={`w-9 h-9 rounded-full flex items-center justify-center font-black ${selectedChildId === child.id ? 'bg-white/20' : 'bg-primary-100 dark:bg-primary-500/20 text-primary-600 dark:text-primary-400'}`}>
                  ...
                  {exams.map((exam) => (
                    <div key={exam.id} className="flex items-center justify-between text-base p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-sm font-bold text-white bg-primary-600 hover:bg-primary-500 px-4 py-2 rounded-xl transition-colors"
                      >
